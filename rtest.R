...
data(gmD); d1=gmD$x
d1 = read.csv('~/Documents/pcalg/datasets/BD Disc.csv', header = TRUE, sep=",")
d1 = read.csv('~/Documents/pcalg/datasets/BD Cont.csv', header = TRUE, sep=",")
d1 = read.csv('~/Documents/pcalg/datasets/BD5 Cluster X Disc Y Outcome (2).csv', header = TRUE, sep=",")
